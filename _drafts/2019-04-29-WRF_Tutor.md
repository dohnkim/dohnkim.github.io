...
1. namelist.wps의 &share 영역과 &geogrid 영역을 수정하고 ncl로 확인합니다.
   ...
   지도 투영 방법에 관한 개념설명은 저의 홈페이지에 있는 " [WRF ARW에서 사용되는 지도 투영법](https://dhkim.tistory.com/273)" 을 참고하세요.
   중위도 지역의 모의에는 보통 "Lambert Conformal" 투영법을 사용하며, 적위도나 적도지역은 "Mercator", 극 지역은 "Polar Stereographic", 전지구 모의에는 "Cylindrical Equidistant" 투영법을 사용합니다.
